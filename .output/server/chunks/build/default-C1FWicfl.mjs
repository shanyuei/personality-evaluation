import { defineComponent, mergeProps, useSSRContext, computed, unref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, Fragment, renderList, createCommentVNode, renderSlot, inject, reactive, provide, ref, mergeModels, useSlots, useModel, watch, toRef, resolveDynamicComponent, withModifiers, toHandlers } from 'vue';
import { d as _export_sfc, _ as __nuxt_component_6, f as useRoute, u as useI18n, Q as useLocaleHead, R as __nuxt_component_8, K as useHead, L as useLocale, g as useAppConfig, M as getSlotChildrenText, t as tv, c as _sfc_main$8$1, N as _sfc_main$9$1, r as isArrayOfArray, v as _sfc_main$b$1, s as _sfc_main$e$1, w as get, O as pickLinkProps, P as _sfc_main$a$1, n as usePortal, p as useFieldGroup, q as useComponentIcons } from './server.mjs';
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "uno-gradient-cta-section uno-relative uno-w-full uno-flex uno-items-center uno-justify-center uno-mb-20 uno-relative" }, _attrs))} data-v-cc60f12f><div class="uno-relative uno-z-10 uno-flex uno-flex-col uno-items-center uno-justify-center uno-gap-2 uno-rounded-[32px] sm:uno-rounded-[48px] uno-w-[342px] md:uno-w-[1200px] uno-h-[438px] uno-px-0 sm:uno-px-8 md:uno-px-12 lg:uno-px-24 uno-py-12 sm:uno-py-16 md:uno-py-20" data-v-cc60f12f>`);
      ...
      _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        width: "1200px",
        height: "438px",
        class: "uno-absolute uno-inset-0 uno--z-10 uno-pointer-events-none uno-object-cover uno-object-center uno-hidden md:uno-block",
        "uno-preload": ""
      }, null, _parent));
      _push(`<h2 class="uno-w-80% uno-text-[#0F172A] uno-relative uno-z-10 uno-font-[&#39;Outfit&#39;] uno-font-bold uno-text-xl sm:uno-text-2xl md:uno-text-3xl lg:uno-text-4xl xl:uno-text-5xl uno-mb-2 sm:uno-mb-3 md:uno-mb-4 uno-text-center" data-v-cc60f12f>${ssrInterpolate(__props.title || _ctx.$t("pages.home.accuracy.title"))}</h2><p class="uno-w-80% uno-text-[#4E5255] uno-relative uno-z-10 uno-max-w-[720px] uno-mx-auto uno-mb-4 sm:uno-mb-6 md:uno-mb-8 lg:uno-mb-10 uno-text-center uno-px-4 uno-text-sm sm:uno-text-base md:uno-text-lg" data-v-cc60f12f>${ssrInterpolate(__props.description || _ctx.$t("pages.home.accuracy.description"))}</p><button class="uno-m-t-12px uno-relative uno-z-10 uno-w-40% md:uno-w-220px sm:uno-m-t-16px md:uno-m-t-24px uno-flex uno-justify-between uno-items-center uno-flex-row uno-gap-[6px] sm:uno-gap-[8px] md:uno-gap-[12px] uno-py-2 sm:uno-py-2 uno-pr-[3px] sm:uno-pr-[4px] md:uno-pr-[6px] uno-pl-[12px] sm:uno-pl-[16px] md:uno-pl-[24px] uno-bg-[var(--ui-primary)] hover:uno-bg-[var(--color-green-2)] uno-text-[#FFFFFF] uno-text-[12px] sm:uno-text-[14px] md:uno-text-[18px] uno-font-[&#39;Outfit&#39;] uno-font-medium uno-rounded-[149.99px] uno-transition uno-duration-200 disabled:uno-opacity-50 disabled:uno-cursor-not-allowed" type="button" data-v-cc60f12f>${ssrInterpolate(_ctx.$t("common.getStarted"))} `);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
const __nuxt_component_9 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$f, [["__scopeId", "data-v-cc60f12f"]]), { __name: "AppCurious" });
...
const __nuxt_component_3 = Object.assign(_sfc_main$4, { __name: "I18nSelect" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UHeader = _sfc_main$a;
      const _component_NuxtImg = __nuxt_component_6;
      const _component_UNavigationMenu = _sfc_main$5;
      const _component_I18nSelect = __nuxt_component_3;
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        ...
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="uno-h-[48px] uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-3 uno-py-1 uno-pr-1 uno-pl-[20px] uno-border-solid uno-border-[#011813] uno-border uno-rounded-[100px] max-sm:uno-hidden"${_scopeId}><span class="uno-text-[#011813] uno-font-[&#39;Outfit&#39;] uno-font-medium"${_scopeId}>${ssrInterpolate(_ctx.$t("header.GetStarted"))}</span>`);
            _push2(ssrRenderComponent(_component_NuxtImg, {
            ...
            return [
              createVNode("div", { class: "uno-h-[48px] uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-3 uno-py-1 uno-pr-1 uno-pl-[20px] uno-border-solid uno-border-[#011813] uno-border uno-rounded-[100px] max-sm:uno-hidden" }, [
                createVNode("span", { class: "uno-text-[#011813] uno-font-['Outfit'] uno-font-medium" }, toDisplayString(_ctx.$t("header.GetStarted")), 1),
                createVNode(_component_NuxtImg, {
                  src: "/images/header/go-icon-1.png",
                  alt: "go-icon-1",
                  width: "40px",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="uno-w-full uno-bottom-0 uno-left-0 uno-z-[2] uno-relative">`);
  _push(ssrRenderComponent(_component_UFooter, { ui: {
    ...
    left: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<p class="uno-text-[#4E5255] uno-font-[&#39;Outfit&#39;] uno-text-sm uno-m-t-12px"${_scopeId}> Unlock knowledge with expert-led online courses. </p><p class="uno-text-[#011813] uno-text-xl uno-font-[&#39;Outfit&#39;] uno-font-medium uno-m-t-24px"${_scopeId}> Stay connected </p><div class="uno-flex uno-gap-12px uno-m-t-16px"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_NuxtImg, {
        ...
        return [
          createVNode("div", { class: "uno-flex uno-flex-col uno-w-210px" }, [
            ...
            createVNode("p", { class: "uno-text-[#4E5255] uno-font-['Outfit'] uno-text-sm uno-m-t-12px" }, " Unlock knowledge with expert-led online courses. "),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-e0f00472>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Body, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="uno-min-h-screen uno-flex uno-flex-col uno-relative" data-v-e0f00472${_scopeId2}>`);
                  ...
                  _push3(`<main class="uno-flex-1 uno-mx-auto uno-z-10 uno-w-full" data-v-e0f00472${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, () => {
                  ...
                  return [
                    createVNode("div", { class: "uno-min-h-screen uno-flex uno-flex-col uno-relative" }, [
                      ...
                      unref(showCurious) ? (openBlock(), createBlock(_component_app_curious, { key: 0 })) : createCommentVNode("", true),
                      unref(showFooter) ? (openBlock(), createBlock(_component_app_footer, { key: 1 })) : createCommentVNode("", true)
                    ])
                  ];
                }
              }),
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e0f00472"]]);

export { _default as default };
//# sourceMappingURL=default-C1FWicfl.mjs.map
