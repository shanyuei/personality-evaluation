...
import { _ as __nuxt_component_1$1 } from './AppLink-DT1Xb_nb.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppLink = __nuxt_component_1$1;
      ...
      _push(ssrRenderComponent(_component_AppLink, { to: "/ebooks/detail" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=index-BHsCtANd.mjs.map
