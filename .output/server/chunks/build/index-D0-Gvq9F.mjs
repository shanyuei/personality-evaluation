import { _ as _sfc_main$1 } from './Input-Cs9A8AMk.mjs';
import { d as _export_sfc, u as useI18n, a as useSeoMeta, c as _sfc_main$8, _ as __nuxt_component_6 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "uno-min-h-screen uno-bg-white" }, _attrs))} data-v-de946790><section class="uno-py-16 uno-px-6 md:uno-px-12 lg:uno-px-24 uno-bg-gray-50" data-v-de946790><div class="uno-max-w-7xl uno-mx-auto" data-v-de946790><h1 class="uno-text-3xl md:uno-text-4xl uno-font-bold uno-text-gray-900 uno-mb-4" data-v-de946790>Our Expert Mentors</h1><p class="uno-text-lg uno-text-gray-600 uno-max-w-3xl" data-v-de946790> Meet our team of experienced professionals who are passionate about guiding you on your learning journey. </p></div></section><section class="uno-py-12 uno-px-6 md:uno-px-12 lg:uno-px-24" data-v-de946790><div class="uno-max-w-7xl uno-mx-auto" data-v-de946790><div class="uno-flex uno-flex-col md:uno-flex-row uno-justify-between uno-items-start md:uno-items-center uno-mb-12 uno-gap-4" data-v-de946790>`);
      ...
      _push(`<div class="uno-flex uno-flex-wrap uno-gap-2" data-v-de946790>`);
      ...
      _push(`</div></div><div class="uno-grid uno-grid-cols-1 sm:uno-grid-cols-2 lg:uno-grid-cols-3 uno-gap-8" data-v-de946790><!--[-->`);
      ssrRenderList(filteredMentors.value, (mentor) => {
        _push(`<div class="uno-bg-white uno-rounded-lg uno-shadow-md uno-overflow-hidden hover:uno-shadow-lg uno-transition-all uno-duration-300 hover:uno--translate-y-1" data-v-de946790><div class="uno-p-6" data-v-de946790><div class="uno-flex uno-flex-col uno-items-center uno-text-center uno-mb-6" data-v-de946790><div class="uno-w-32 uno-h-32 uno-rounded-full uno-overflow-hidden uno-border-4 uno-border-white uno-shadow-md uno-mb-4" data-v-de946790>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: mentor.avatar,
          alt: mentor.name,
          class: "uno-w-full uno-h-full uno-object-cover"
        }, null, _parent));
        _push(`</div><h3 class="uno-text-xl uno-font-bold uno-text-gray-900 uno-mb-1" data-v-de946790>${ssrInterpolate(mentor.name)}</h3><p class="uno-text-primary uno-font-medium uno-mb-2" data-v-de946790>${ssrInterpolate(mentor.title)}</p><div class="uno-flex uno-items-center uno-justify-center uno-mb-4" data-v-de946790><span class="uno-text-amber-500 uno-mr-1" data-v-de946790>★</span><span class="uno-text-sm uno-font-medium" data-v-de946790>${ssrInterpolate(mentor.rating)} (${ssrInterpolate(mentor.students)} students)</span></div><div class="uno-flex uno-flex-wrap uno-gap-2 uno-justify-center uno-mb-4" data-v-de946790><!--[-->`);
        ssrRenderList(mentor.skills, (skill) => {
          _push(`<span class="uno-text-xs uno-bg-gray-100 uno-text-gray-800 uno-px-3 uno-py-1 uno-rounded-full" data-v-de946790>${ssrInterpolate(skill)}</span>`);
        });
        _push(`<!--]--></div></div><p class="uno-text-gray-600 uno-text-sm uno-mb-6 uno-line-clamp-3" data-v-de946790>${ssrInterpolate(mentor.bio)}</p><div class="uno-flex uno-justify-between uno-items-center" data-v-de946790><span class="uno-text-sm uno-text-gray-500" data-v-de946790>${ssrInterpolate(mentor.courses)} courses</span>`);
      ...
      if (filteredMentors.value.length === 0) {
        _push(`<div class="uno-text-center uno-py-16" data-v-de946790><p class="uno-text-gray-600 uno-text-lg" data-v-de946790>No mentors found matching your criteria.</p>`);
        _push(ssrRenderComponent(_component_UButton, {
      ...
      _push(`</div></section><section class="uno-py-16 uno-px-6 md:uno-px-12 lg:uno-px-24 uno-bg-gray-50" data-v-de946790><div class="uno-max-w-7xl uno-mx-auto" data-v-de946790><h2 class="uno-text-2xl md:uno-text-3xl uno-font-bold uno-text-center uno-text-gray-900 uno-mb-12" data-v-de946790>Student Success Stories</h2><div class="uno-grid uno-grid-cols-1 md:uno-grid-cols-2 uno-gap-8" data-v-de946790><div class="uno-bg-white uno-p-6 uno-rounded-lg uno-shadow-md" data-v-de946790><div class="uno-flex uno-items-center uno-mb-4" data-v-de946790><div class="uno-text-amber-500 uno-flex" data-v-de946790><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span></div></div><p class="uno-text-gray-700 uno-mb-4 uno-italic" data-v-de946790> &quot;My mentor provided invaluable guidance throughout my learning journey. Their industry experience and personalized feedback helped me land my dream job.&quot; </p><div class="uno-flex uno-items-center" data-v-de946790><div class="uno-w-10 uno-h-10 uno-rounded-full uno-overflow-hidden uno-mr-3" data-v-de946790>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/images/students/alice.jpg",
        alt: "Alice",
        class: "uno-w-full uno-h-full uno-object-cover"
      }, null, _parent));
      _push(`</div><div data-v-de946790><p class="uno-font-medium uno-text-gray-900" data-v-de946790>Alice Thompson</p><p class="uno-text-sm uno-text-gray-600" data-v-de946790>Software Developer at TechCorp</p></div></div></div><div class="uno-bg-white uno-p-6 uno-rounded-lg uno-shadow-md" data-v-de946790><div class="uno-flex uno-items-center uno-mb-4" data-v-de946790><div class="uno-text-amber-500 uno-flex" data-v-de946790><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span><span data-v-de946790>★</span></div></div><p class="uno-text-gray-700 uno-mb-4 uno-italic" data-v-de946790> &quot;The mentorship program exceeded my expectations. My mentor was knowledgeable, supportive, and pushed me to achieve more than I thought possible.&quot; </p><div class="uno-flex uno-items-center" data-v-de946790><div class="uno-w-10 uno-h-10 uno-rounded-full uno-overflow-hidden uno-mr-3" data-v-de946790>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/images/students/bob.jpg",
        alt: "Bob",
        class: "uno-w-full uno-h-full uno-object-cover"
      }, null, _parent));
      _push(`</div><div data-v-de946790><p class="uno-font-medium uno-text-gray-900" data-v-de946790>Bob Johnson</p><p class="uno-text-sm uno-text-gray-600" data-v-de946790>UX Designer at CreativeStudio</p></div></div></div></div></div></section></main>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de946790"]]);

export { index as default };
//# sourceMappingURL=index-D0-Gvq9F.mjs.map
