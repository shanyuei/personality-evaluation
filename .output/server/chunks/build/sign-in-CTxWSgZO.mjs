...
import { d as _export_sfc, u as useI18n, a as useSeoMeta, c as _sfc_main$8, b as __nuxt_component_1$1, g as useAppConfig, t as tv, h as formBusInjectionKey, i as formStateInjectionKey, j as formErrorsInjectionKey, k as formInputsInjectionKey, l as formLoadingInjectionKey, m as formOptionsInjectionKey } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "uno-relative uno-flex uno-items-center uno-justify-center uno-py-24 sm:uno-py-32" }, _attrs))} data-v-dbf60b43><div class="uno-w-full uno-max-w-[720px] uno-px-6 sm:uno-px-10" data-v-dbf60b43><div class="uno-rounded-[24px] uno-p-8 sm:uno-p-10" data-v-dbf60b43><h1 class="uno-text-center uno-mb-10 uno-text-[#0F172A] uno-font-[&#39;Outfit&#39;] uno-font-bold uno-text-4xl sm:uno-text-5xl" data-v-dbf60b43>${ssrInterpolate(_ctx.$t("pages.auth.signIn.title"))}</h1>`);
      ...
      _push(`<div class="uno-flex uno-items-center uno-justify-between uno-mt-6" data-v-dbf60b43><p class="uno-text-[#8d8e8f] uno-font-[&#39;Outfit&#39;]" data-v-dbf60b43>${ssrInterpolate(_ctx.$t("pages.auth.signIn.noAccount"))}</p>`);
...
const signIn = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dbf60b43"]]);

export { signIn as default };
//# sourceMappingURL=sign-in-CTxWSgZO.mjs.map
