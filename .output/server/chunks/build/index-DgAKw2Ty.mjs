...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "uno-py-12 sm:uno-py-16 md:uno-py-24 lg:uno-py-32" }, _attrs))} data-v-935c9ddb><div class="page-container uno-relative uno-rounded-xl uno-border uno-border-transparent uno-px-4 sm:uno-px-6 md:uno-px-8" data-v-935c9ddb><div class="uno-flex uno-justify-start uno-items-center uno-flex-col" data-v-935c9ddb><div class="uno-flex uno-justify-start uno-items-center uno-flex-col uno-gap-12px sm:uno-gap-16px md:uno-gap-24px" data-v-935c9ddb><h1 class="uno-text-[#011813] uno-text-xl sm:uno-text-2xl md:uno-text-5xl lg:uno-text-7xl uno-font-[&#39;Outfit&#39;] uno-text-center uno-font-semibold" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.title"))}</h1><h2 class="uno-text-[#4E5255] uno-font-[400] uno-text-xs sm:uno-text-sm md:uno-text-lg uno-font-[&#39;Outfit&#39;] uno-text-center" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.description"))}</h2></div><button class="uno-m-t-32px sm:uno-m-t-48px md:uno-m-t-72px uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-[8px] sm:uno-gap-[12px] md:uno-gap-[18px] uno-py-2 sm:uno-py-3 md:uno-py-4 uno-pr-2 sm:uno-pr-3 md:uno-pr-3 uno-pl-[20px] sm:uno-pl-[24px] md:uno-pl-[48px] uno-bg-[#009D77] hover:uno-bg-[var(--color-green-2)] uno-text-[#FFFFFF] uno-text-[14px] sm:uno-text-[18px] md:uno-text-[28px] uno-font-[&#39;Outfit&#39;] uno-font-medium uno-rounded-[149.99px] uno-transition uno-duration-200 disabled:uno-opacity-50 disabled:uno-cursor-not-allowed" type="button" data-v-935c9ddb> Take the Test `);
      ...
      _push(`</button></div></div><div class="page-container uno-hero-section uno-w-full uno-my-12" data-v-935c9ddb><div class="uno-flex uno-justify-center uno-items-center uno-gap-2 sm:uno-gap-3 md:uno-gap-4 lg:uno-gap-6 xl:uno-gap-6" data-v-935c9ddb><!--[-->`);
      ssrRenderList(unref(heroAvatars), (hero, index2) => {
        _push(`<div class="uno-hero-avatar uno-relative uno-w-26 uno-h-34 md:uno-w-32 md:uno-h-48 lg:uno-w-32 lg:uno-h-48 xl:uno-w-40 xl:uno-h-64 uno-overflow-hidden uno-flex uno-items-center uno-justify-center" data-v-935c9ddb>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: hero.src,
          alt: hero.alt,
      ...
      _push(`<!--]--></div></div><div class="uno-data-stats uno-bg-[#F5F8FF] uno-my-12" data-v-935c9ddb><div class="page-container uno-px-4" data-v-935c9ddb><div class="uno-grid uno-grid-cols-2 md:uno-grid-cols-4 uno-gap-3 sm:uno-gap-4 md:uno-gap-6" data-v-935c9ddb><!--[-->`);
      ssrRenderList(statsItems, (item, index2) => {
        _push(`<div class="uno-text-center uno-p-3 sm:uno-p-4 md:uno-p-6 uno-flex uno-flex-col uno-justify-center uno-items-center" data-v-935c9ddb><div style="${ssrRenderStyle({ color: item.color })}" class="uno-text-lg sm:uno-text-2xl md:uno-text-4xl lg:uno-text-5xl uno-font-[&#39;Outfit&#39;] uno-font-semibold uno-m-b-1px sm:uno-m-b-2px md:uno-m-b-4px" data-v-935c9ddb>${ssrInterpolate(item.value)}</div><div class="uno-text-[#4E5255] uno-text-xs sm:uno-text-sm md:uno-text-base lg:uno-text-lg uno-font-[&#39;Outfit&#39;]" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(item.labelKey))}</div></div>`);
      });
      _push(`<!--]--></div></div></div><div class="page-container uno-intro-section uno-py-12 sm:uno-py-16 md:uno-py-20 lg:uno-py-24" data-v-935c9ddb><div class="uno-px-4" data-v-935c9ddb><div class="uno-mb-12 sm:uno-mb-16 md:uno-mb-20 lg:uno-mb-24" data-v-935c9ddb><div class="uno-max-w-[700px] uno-mx-auto" data-v-935c9ddb><h2 class="uno-text-[#011813] uno-text-2xl sm:uno-text-3xl md:uno-text-4xl lg:uno-text-5xl uno-font-[&#39;Outfit&#39;] uno-text-center uno-font-semibold uno-m-b-6px sm:uno-m-b-8px md:uno-m-b-12px" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.why.title"))}</h2><p class="uno-text-[#4E5255] uno-font-[&#39;Outfit&#39;] uno-text-center uno-text-sm sm:uno-text-base uno-mb-[56px] sm:uno-mb-[80px]" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.why.desc"))}</p></div><div class="uno-shadow-lg uno-mb-6 sm:uno-mb-8 md:uno-mb-10 lg:uno-mb-12 uno-w-full uno-bg-[#F8F8F8] uno-border-solid uno-border-[#E7E7E8] uno-border uno-rounded-[32px] uno-p-[24px] uno-relative uno-overflow-hidden" data-v-935c9ddb><div class="uno-flex uno-flex-col md:uno-flex-row uno-items-center uno-gap-8 md:uno-gap-12" data-v-935c9ddb><div class="uno-w-full md:uno-w-[45%] uno-flex uno-flex-col uno-justify-center uno-relative" data-v-935c9ddb><div class="uno-w-12 uno-h-12 uno-bg-[#E0F2EF] uno-rounded-xl uno-flex uno-items-center uno-justify-center uno-mb-6" data-v-935c9ddb>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`</div><h3 class="uno-text-[24px] sm:uno-text-[28px] md:uno-text-[32px] uno-font-[&#39;Outfit&#39;] uno-font-bold uno-mb-4 uno-text-[#011813] uno-leading-tight" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.why.main.title"))}</h3><p class="uno-text-[#4E5255] uno-text-base sm:uno-text-lg uno-mb-6 uno-leading-relaxed" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.why.main.desc"))}</p><div class="uno-w-full uno-h-[1px] uno-bg-[#E7E7E8] uno-mb-6" data-v-935c9ddb></div><div class="uno-relative uno-inline-flex" data-v-935c9ddb><button class="uno-group uno-pl-6 uno-pr-2 uno-py-2 uno-bg-[var(--ui-primary)] hover:uno-bg-[var(--color-green-2)] uno-text-white uno-rounded-full uno-flex uno-items-center uno-gap-3 uno-transition-all uno-duration-300" type="button" data-v-935c9ddb><span class="uno-font-[&#39;Outfit&#39;] uno-font-medium uno-text-[16px]" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("common.getStarted"))}</span>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/images/common/go-arrow-1.png",
        alt: "arrow-right",
        width: "44",
      ...
      _push(`</button></div></div><div class="uno-w-full md:uno-w-[55%] uno-relative" data-v-935c9ddb>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/images/home/1.png",
        alt: "Self-awareness illustration",
        class: "uno-w-full uno-h-auto uno-object-contain uno-rounded-2xl"
      }, null, _parent));
      _push(`</div></div></div><div class="uno-grid uno-grid-cols-1 md:uno-grid-cols-3 uno-gap-3 sm:uno-gap-4 md:uno-gap-6 lg:uno-gap-8 uno-px-2 sm:uno-px-0" data-v-935c9ddb><!--[-->`);
      ssrRenderList(whyCards, (card, index2) => {
        _push(`<div class="uno-bg-[#F8F8F8] uno-border-solid uno-border-[#E7E7E8] uno-border uno-rounded-3xl uno-p-12px sm:uno-p-16px md:uno-p-24px uno-shadow-lg uno-relative" data-v-935c9ddb><div class="${ssrRenderClass([card.iconColor, "uno-mb-2 sm:uno-mb-3 md:uno-mb-4"])}" data-v-935c9ddb>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: card.icon,
          alt: card.alt,
          width: "32",
        ...
        _push(`</div><h3 class="uno-text-base sm:uno-text-lg md:uno-text-[32px] uno-font-[&#39;Outfit&#39;] uno-font-bold uno-mb-2 sm:uno-mb-3" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(card.titleKey))}</h3><p class="uno-text-gray-600 uno-text-xs sm:uno-text-sm md:uno-text-base" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(card.descKey))}</p></div>`);
      });
      _push(`<!--]--></div></div><div class="uno-flex uno-flex-col md:uno-flex-row uno-gap-8 sm:uno-gap-12 uno-items-center" data-v-935c9ddb><div class="uno-w-full md:uno-w-1/2" data-v-935c9ddb><h2 class="uno-text-[32px] sm:uno-text-[48px] md:uno-text-[48px] uno-font-[&#39;Outfit&#39;] uno-font-bold uno-mb-6 sm:uno-mb-8" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.how.title"))}</h2><p class="uno-text-gray-600 uno-mb-8 sm:uno-mb-12" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.how.desc"))}</p><button class="uno-m-t-12px sm:uno-m-t-16px md:uno-m-t-24px uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-[6px] sm:uno-gap-[8px] md:uno-gap-[12px] uno-py-2 sm:uno-py-2 uno-pr-[3px] sm:uno-pr-[4px] md:uno-pr-[6px] uno-pl-[12px] sm:uno-pl-[16px] md:uno-pl-[24px] uno-bg-[var(--ui-primary)] hover:uno-bg-[var(--color-green-2)] uno-text-[#FFFFFF] uno-text-[12px] sm:uno-text-[14px] md:uno-text-[16px] uno-font-[&#39;Outfit&#39;] uno-font-medium uno-rounded-[149.99px] uno-transition uno-duration-200 disabled:uno-opacity-50 disabled:uno-cursor-not-allowed" type="button" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("common.getStarted"))} `);
      _push(ssrRenderComponent(_component_NuxtImg, {
        src: "/images/common/go-arrow-1.png",
        alt: "arrow-right",
        width: "44",
      ...
      _push(`</button></div><div class="uno-w-full md:uno-w-1/2" data-v-935c9ddb><div class="uno-flex uno-justify-start uno-items-end uno-flex-col uno-gap-4 sm:uno-gap-6" data-v-935c9ddb><!--[-->`);
      ssrRenderList(howSteps, (item, index2) => {
        _push(`<div style="${ssrRenderStyle({ "flex-shrink": "0" })}" class="uno-w-full uno-flex uno-justify-start uno-items-center uno-flex-row uno-gap-[12px] sm:uno-gap-[12px] uno-py-16px sm:uno-py-24px uno-px-16px sm:uno-px-24px uno-bg-[#FFFFFF] uno-rounded-2xl uno-shadow-[0_20px_40px_0_rgba(0,157,119,0.08)] uno-border uno-border-solid uno-border-[#F0F0F0]" data-v-935c9ddb><div style="${ssrRenderStyle({ "flex": "none" })}" class="${ssrRenderClass([item.bgClass, "uno-w-[48px] uno-h-[48px] sm:uno-w-[64px] sm:uno-h-[64px] uno-flex uno-justify-center uno-items-center uno-rounded-[24px] sm:uno-rounded-[50px] uno-flex uno-items-center uno-justify-center"])}" data-v-935c9ddb><span class="${ssrRenderClass([item.textClass, "uno-text-3xl sm:uno-text-[36px] uno-font-['Outfit'] uno-font-semibold uno-mb-[6px]"])}" data-v-935c9ddb>${ssrInterpolate(item.step)}</span></div><div class="uno-flex uno-justify-start uno-items-start uno-flex-col uno-gap-1 sm:uno-gap-2" data-v-935c9ddb><p class="uno-text-[#011813] uno-text-xl sm:uno-text-2xl uno-font-[&#39;Outfit&#39;] uno-font-semibold" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(item.titleKey))}</p><p class="uno-w-full uno-text-[#4E5255] uno-font-[&#39;Outfit&#39;]" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(item.descKey))}</p></div></div>`);
      });
      _push(`<!--]--></div></div></div></div></div><div class="uno-receive-section uno-bg-gray-5 uno-relative" data-v-935c9ddb>`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`<div class="page-container uno-px-4 uno-py-8 sm:uno-py-12 md:uno-py-16 lg:uno-py-20 xl:uno-py-24 relative z-10" data-v-935c9ddb><h2 class="uno-text-xl sm:uno-text-2xl md:uno-text-4xl uno-font-[&#39;Outfit&#39;] uno-font-bold uno-text-center uno-mb-2 sm:uno-mb-3 md:uno-mb-4" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.receive.title"))}</h2><p class="uno-text-center uno-text-gray-600 uno-text-xs sm:uno-text-sm md:uno-text-base uno-mb-6 sm:uno-mb-8 md:uno-mb-16 uno-max-w-3xl uno-mx-auto" data-v-935c9ddb>${ssrInterpolate(_ctx.$t("pages.home.receive.desc"))}</p><div class="uno-grid uno-grid-cols-1 md:uno-grid-cols-3 uno-gap-[24px] sm:uno-gap-[24px] md:uno-gap-[24px]" data-v-935c9ddb><!--[-->`);
      ssrRenderList(receiveCards, (card, index2) => {
        _push(`<div class="uno-bg-white uno-rounded-[32px] uno-shadow-[0_2px_8px_rgba(0,0,0,0.04)] uno-p-8 sm:uno-p-10 uno-border uno-border-[#F0F0F0] uno-flex uno-flex-col uno-items-center uno-text-center uno-gap-4 sm:uno-gap-6 uno-min-h-[280px]" data-v-935c9ddb><div class="uno-w-64px uno-h-64px sm:uno-w-64px sm:uno-h-64px uno-flex uno-items-center uno-justify-center uno-bg-gray-50 uno-rounded-full uno-mb-2" data-v-935c9ddb>`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: card.icon,
          alt: card.alt,
          width: "64",
        ...
        _push(`</div><h3 class="uno-text-lg sm:uno-text-xl md:uno-text-2xl uno-font-[&#39;Outfit&#39;] uno-font-bold uno-leading-tight uno-px-2" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(card.titleKey))}</h3><p class="uno-text-gray-500 uno-text-sm sm:uno-text-base uno-font-[&#39;Outfit&#39;] uno-leading-relaxed" data-v-935c9ddb>${ssrInterpolate(_ctx.$t(card.descKey))}</p></div>`);
      });
      _push(`<!--]--></div></div></div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-935c9ddb"]]);

export { index as default };
//# sourceMappingURL=index-DgAKw2Ty.mjs.map
