import { defineComponent, mergeProps, withCtx, createVNode, useSSRContext, computed, unref, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, renderSlot, inject, reactive, provide, ref, mergeModels, useSlots, useModel, watch, toRef, resolveDynamicComponent, withModifiers, createSlots, toHandlers } from 'vue';
import { d as _export_sfc, _ as __nuxt_component_6$1, b as useRoute, u as useI18n, f as useRouter, V as useLocaleHead, W as __nuxt_component_8, c as useHead, H as useCookie, a as useLocalePath, p as _sfc_main$e$1, o as navigateTo, P as useLocale, h as useAppConfig, Q as getSlotChildrenText, t as tv, g as _sfc_main$8$1, R as _sfc_main$9$1, x as isArrayOfArray, y as _sfc_main$b$1, z as get, S as pickLinkProps, T as _sfc_main$a$1, U as omit, r as usePortal, v as useFieldGroup, w as useComponentIcons } from './server.mjs';
...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "uno-gradient-cta-section uno-relative uno-w-full uno-flex uno-items-center uno-justify-center uno-mb-20 uno-relative" }, _attrs))} data-v-544d42ba>`);
      ...
      _push(ssrRenderComponent(_component_AppArrowButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-[calc(100%-44px)] text-center uno-text-16px" data-v-544d42ba${_scopeId}> Take the Test </div>`);
          } else {
            return [
              createVNode("div", { class: "w-[calc(100%-44px)] text-center uno-text-16px" }, " Take the Test ")
            ];
          }
        }),
        _: 1
...
const __nuxt_component_9 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$h, [["__scopeId", "data-v-544d42ba"]]), { __name: "AppCurious" });
...
const __nuxt_component_6 = Object.assign(_sfc_main$4, { __name: "I18nSelect" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_I18nSelect = __nuxt_component_6;
      _push(ssrRenderComponent(_component_UHeader, mergeProps({
        ...
        right: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!unref(token)) {
              _push2(ssrRenderComponent(_component_AppArrowButton, {
                preset: "header",
                class: "max-sm:uno-hidden uno-font-['Outfit'] uno-font-medium",
                to: unref(localePath)("/auth/sign-in")
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(_ctx.$t("common.getStarted"))}`);
                  } else {
                    return [
            ...
            return [
              !unref(token) ? (openBlock(), createBlock(_component_AppArrowButton, {
                key: 0,
                preset: "header",
                class: "max-sm:uno-hidden uno-font-['Outfit'] uno-font-medium",
                to: unref(localePath)("/auth/sign-in")
                ...
                _: 1
              }, 8, ["to"])) : (openBlock(), createBlock(_component_UDropdownMenu, {
                key: 1,
                items: accountItems.value,
                ui: { item: "data-[disabled]:cursor-text data-[disabled]:select-text uno-px-3 uno-py-2", content: "uno-p-1 uno-bg-white uno-ring-1 uno-ring-gray-200 uno-rounded-xl uno-shadow-lg uno-min-w-[200px]" },
                content: { align: "end", side: "bottom", sideOffset: 8 }
            ...
            return [
              createVNode("div", { class: "uno-flex uno-flex-col uno-items-start uno-gap-4 uno-p-24px uno-bg-[#FFFFFF] uno-border-[1px] uno-border-[#F0F0F0] uno-rounded-[16px] uno-w-[374px]" }, [
                ...
                createVNode("div", null, [
                  createVNode(_component_AppArrowButton, {
                    variant: "outline",
                    class: "uno-h-[48px] uno-gap-3 uno-py-1 uno-pr-1 uno-pl-[20px] uno-rounded-[100px] uno-w-full uno-font-['Outfit'] uno-font-medium",
                    "icon-size": 40,
                    to: unref(localePath)("/auth/sign-in"),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  props: {
    layoutShowPageTopIcons: { type: Boolean, default: true }
  },
  setup(__props) {
    const route = useRoute();
    const { t } = useI18n();
    ...
    const showPageTopIcons = computed(() => {
      if (route.meta.layoutShowPageTopIcons !== void 0) {
    ...
    const pageTopIcon3Class = computed(() => {
      return route.meta.layoutPageTopIcon3Class || "uno-top-252px uno-right-120px";
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-b70d76ec>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_Body, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="uno-min-h-screen uno-flex uno-flex-col uno-relative" data-v-b70d76ec${_scopeId2}>`);
                  ...
                  if (unref(showPageTopIcons3)) {
                    _push3(ssrRenderComponent(_component_NuxtImg, {
                      ...
                      width: "104",
                      height: "44",
                      class: ["uno-absolute uno-z-1", unref(pageTopIcon3Class)]
                    }, null, _parent3, _scopeId2));
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(ssrRenderComponent(_component_app_header, { "show-menu": unref(showMenu) }, null, _parent3, _scopeId2));
                  _push3(`<main class="uno-flex-1 uno-mx-auto uno-z-10 uno-w-full" data-v-b70d76ec${_scopeId2}>`);
                  ssrRenderSlot(_ctx.$slots, "default", {}, () => {
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b70d76ec"]]);

export { _default as default };
//# sourceMappingURL=default-Dpc1b6IC.mjs.map
