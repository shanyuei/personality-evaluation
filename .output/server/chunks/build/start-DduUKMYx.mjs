  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/test/step",
        class: "uno-block uno-w-full uno-max-w-[880px] uno-mx-auto"
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, { ui: unref(UButtonTheme) }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(_ctx.$t("pages.testStart.cta.getStarted"))}`);
                } else {
                  return [
...
//# sourceMappingURL=start-DduUKMYx.mjs.map
