import { u as useI18n, a as useSeoMeta, _ as __nuxt_component_6, b as __nuxt_component_1$1 } from './server.mjs';
import { h as getArticleBySlug, c as getLatestArticles, u as updatePreviewBySlug, d as getImageUrl, f as formatDate } from './blog-C_PW3FG0.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="uno-grid md:uno-grid-cols-3 uno-gap-[24px] uno-mt-24px">`);
      if (unref(article)) {
      ...
      _push(`<div><div class="uno-rounded-2xl uno-mb-6"><h3 class="uno-text-lg uno-font-semibold uno-text-gray-900 uno-mb-4">${ssrInterpolate(_ctx.$t("pages.blog.sidebar.recent"))}</h3><ul class="uno-space-y-4"><!--[-->`);
      ssrRenderList(unref(recentArticles), (recent) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="uno-rounded-[12px] uno-overflow-hidden uno-flex-shrink-0"${_scopeId}>`);
              ...
              _push2(`</div><div${_scopeId}><h4 class="uno-font-medium uno-text-[18px] uno-text-[#011813] uno-leading-[26px] group-hover:uno-text-[var(--ui-primary)] uno-transition-colors uno-duration-200 uno-line-clamp-1"${_scopeId}>${ssrInterpolate(recent.title)}</h4><p class="uno-font-normal uno-text-[14px] uno-text-[#4e5255] uno-leading-[20px] uno-mt-1 uno-line-clamp-2"${_scopeId}>${ssrInterpolate(recent.excerpt)}</p></div>`);
            } else {
              return [
                ...
                createVNode("div", null, [
                  createVNode("h4", { class: "uno-font-medium uno-text-[18px] uno-text-[#011813] uno-leading-[26px] group-hover:uno-text-[var(--ui-primary)] uno-transition-colors uno-duration-200 uno-line-clamp-1" }, toDisplayString(recent.title), 1),
                  createVNode("p", { class: "uno-font-normal uno-text-[14px] uno-text-[#4e5255] uno-leading-[20px] uno-mt-1 uno-line-clamp-2" }, toDisplayString(recent.excerpt), 1)
                ])
              ];
            }
          }),
      ...
      _push(`<!--]--></ul></div><div class="uno-rounded-2xl uno-py-6"><h3 class="uno-text-lg uno-font-semibold uno-text-gray-900 uno-mb-3">${ssrInterpolate(_ctx.$t("pages.blog.sidebar.follow"))}</h3><div class="uno-flex uno-gap-3"><a href="#" aria-label="Twitter" class="uno-w-[32px] uno-h-[32px] uno-rounded-full uno-flex uno-items-center uno-justify-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`</a><a href="#" aria-label="Facebook" class="uno-w-[32px] uno-h-[32px] uno-rounded-full uno-flex uno-items-center uno-justify-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`</a><a href="#" aria-label="Instagram" class="uno-w-[32px] uno-h-[32px] uno-rounded-full uno-flex uno-items-center uno-justify-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
      ...
      _push(`</a><a href="#" aria-label="LinkedIn" class="uno-w-[32px] uno-h-[32px] uno-rounded-full uno-flex uno-items-center uno-justify-center">`);
      _push(ssrRenderComponent(_component_NuxtImg, {
...
//# sourceMappingURL=_slug_-C7j1POvF.mjs.map
