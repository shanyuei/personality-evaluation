import { u as useI18n, b as useRoute, f as useRouter, a as useLocalePath, e as useSeoMeta, _ as __nuxt_component_6, g as _sfc_main$8 } from './server.mjs';
...
const __nuxt_component_1 = Object.assign(_sfc_main$1, { __name: "IconsSad" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconsSad = __nuxt_component_1;
      ...
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(currentStep) < unref(totalSteps) ? _ctx.$t("pages.testIntro.ctaNext") : _ctx.$t("pages.testIntro.ctaSubmit"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(currentStep) < unref(totalSteps) ? _ctx.$t("pages.testIntro.ctaNext") : _ctx.$t("pages.testIntro.ctaSubmit")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=step-CzZ2dpAJ.mjs.map
