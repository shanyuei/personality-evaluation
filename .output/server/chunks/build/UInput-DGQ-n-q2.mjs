...
import { g as useAppConfig, t as tv, j as formErrorsInjectionKey, k as formInputsInjectionKey, F as inputIdInjectionKey, G as formFieldInjectionKey } from './server.mjs';
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parse_98c83e5e7de1a5db25516d8987e26607/node_modules/@nuxt/ui/dist/runtime/components/FormField.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const UFormFieldTheme = {
  label: "font-semibold text-[16px] text-[#323233] leading-[24px]",
  wrapper: "mb-[8px]"
};
const UInputTheme = {
  root: "w-full",
  base: "py-[16px] px-[16px] font-normal text-[16px] text-[var(--ui-foreground)] leading-[24px] rounded-[8px] border border-[var(--ui-border)] bg-[var(--ui-background)]",
  placeholder: "text-[var(--ui-muted-foreground)]",
  focus: "border-[var(--ui-primary)] ring-2 ring-[rgba(0,157,119,0.2)] outline-none",
  disabled: "bg-[var(--ui-muted)] text-[var(--ui-muted-foreground)] cursor-not-allowed",
  error: "border-[#EF4444] ring-2 ring-[rgba(239,68,68,0.2)]"
};

export { UFormFieldTheme as U, _sfc_main as _, UInputTheme as a };
//# sourceMappingURL=UInput-DGQ-n-q2.mjs.map
