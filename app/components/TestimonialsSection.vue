            ...
            <Swiper v-if="firstRow.length" :modules="[Autoplay]" :slides-per-view="1" :space-between="16" :loop="true"
              ...
              <SwiperSlide v-for="(item, idx) in firstRow" :key="'f-' + idx">
                <div class="uno-py-12px">
                  <div
                    class="uno-bg-[var(--ui-background)] uno-rounded-2xl hover:uno-shadow-[0_12px_24px_rgba(0,157,119,0.12)] uno-transition-all uno-duration-300 hover:uno-translate-y-[-4px] uno-p-6 uno-border uno-border-solid uno-border-[#F0F0F0] uno-w-full uno-max-w-[400px] uno-h-[331px]">
            ...
            <Swiper v-if="mobileData.length" :modules="[Pagination]" :slides-per-view="1" :space-between="16"
              ...
              <SwiperSlide v-for="(d, idx) in mobileData" :key="'f-' + idx">
                <div v-for="(item, itemIdx) in d" :key="itemIdx" class="uno-py-12px">
                  <div
                    class="uno-bg-[var(--ui-background)] uno-rounded-2xl uno-shadow-md hover:uno-shadow-[0_12px_24px_rgba(0,157,119,0.12)] uno-transition-all uno-duration-300 hover:uno-translate-y-[-4px] uno-p-24px uno-border uno-border-solid uno-border-[#F0F0F0] uno-w-full ">
