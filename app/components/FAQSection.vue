        ...
        <div v-for="(item, idx) in localItems" :key="idx"
            ...
            <div class="uno-flex uno-justify-start uno-items-start uno-flex-col uno-relative">
              <div
                ...
                <div 
                  ...
                  <p
                    class="uno-text-[#009D77] uno-text-xl md:uno-text-2xl uno-font-Outfit uno-text-left uno-font-medium">
                  ...
                  <svg class="uno-w-6 uno-h-6 uno-min-w-6 uno-min-h-6 uno-flex-shrink-0"
                    ...
                    <g uno-clip-path="url(#master_svg0_0_17743)">
                      <g>
                        <path
                          ...
                          uno-fill-rule="evenodd" fill="#009D77" uno-fill-opacity="1" />
                      </g>
                    </g>
                  </svg>
                </div>
          ...
          <div v-else>
            <div
              ...
              @click="toggle(idx)">
              <span class="uno-text-[#011813] uno-text-xl md:uno-text-2xl uno-font-Outfit uno-text-left uno-font-medium">
                {{ item.question||item.title }}
              </span>
              <svg class="uno-w-6 uno-h-6 uno-min-w-6 uno-min-h-6 uno-flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
                ...
                <g uno-clip-path="url(#master_svg0_0_17747)">
                  <g>
                    <path
                      ...
                      uno-fill-rule="evenodd" fill="#011813" uno-fill-opacity="1" />
                  </g>
                </g>
              </svg>
            </div>
