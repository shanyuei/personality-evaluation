<template>
  <button
    :class="[
      'uno-w-[324px] uno-h-[56px] uno-gap-1 uno-opacity-100 uno-pt-[6px] uno-pr-[6px] uno-pb-[6px] uno-pl-[6px] uno-rounded-[8px] uno-font-Outfit uno-font-bold uno-text-[18px] uno-leading-[150%] uno-tracking-[0%] uno-vertical-align-middle uno-w-full',
