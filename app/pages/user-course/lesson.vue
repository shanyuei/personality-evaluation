  ...
  <main class="uno-min-h-screen uno-bg-gradient-to-br uno-from-[var(--color-green-4)] uno-to-[var(--color-pink-4)] uno-py-6 uno-px-4 md:uno-px-10">
    <div class="uno-max-w-[80%] uno-mx-auto">
      ...
      <div class="uno-flex uno-items-center uno-justify-between uno-text-[var(--ui-muted-foreground)] uno-mb-2">
        <NuxtLink to="/user-course/chapters" class="uno-inline-flex uno-items-center uno-gap-2 hover:uno-text-[var(--ui-foreground)]">
        ...
        <div class="uno-text-sm md:uno-text-base">{{ $t('pages.userCourseLesson.lessonCount', { current, total }) }}</div>
      ...
      <div class="uno-mt-4 uno-w-full md:uno-w-[1000px] uno-mx-auto uno-bg-white uno-rounded-[20px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
        <div class="uno-p-6 md:uno-p-8">
          <h1 class="uno-text-2xl md:uno-text-3xl uno-font-['Outfit'] uno-font-extrabold uno-text-[var(--ui-foreground)] uno-mb-4">{{ $t('pages.userCourseLesson.title') }}</h1>

          <!-- Active Listening -->
          <section class="uno-space-y-2 uno-mb-6">
            <p class="uno-text-[var(--ui-foreground)] uno-font-semibold">{{ $t('pages.userCourseLesson.sections.activeListening.title') }}:</p>
            <p class="uno-text-[var(--ui-foreground)] uno-font-medium">{{ $t('pages.userCourseLesson.sections.activeListening.descriptionTitle') }}:</p>
            <p class="uno-text-sm md:uno-text-base uno-text-[var(--ui-muted-foreground)]">{{ $t('pages.userCourseLesson.sections.activeListening.descriptionBody') }}</p>
            <p class="uno-text-[var(--ui-foreground)] uno-font-medium">{{ $t('pages.userCourseLesson.sections.activeListening.applicationTitle') }}:</p>
            <p class="uno-text-sm md:uno-text-base uno-text-[var(--ui-muted-foreground)]">{{ $t('pages.userCourseLesson.sections.activeListening.applicationBody') }}</p>
          </section>

          <!-- Effective Speaking -->
          <section class="uno-space-y-2 uno-mb-6">
            <p class="uno-text-[var(--ui-foreground)] uno-font-semibold">{{ $t('pages.userCourseLesson.sections.effectiveSpeaking.title') }}:</p>
          </section>
          ...
          <div class="uno-mt-8 uno-grid uno-grid-cols-1 md:uno-grid-cols-2 uno-gap-4">
            <UButton class="uno-h-[48px] uno-rounded-[12px] uno-bg-[#011813] hover:uno-opacity-90 uno-text-[var(--ui-primary)] uno-flex uno-items-center uno-justify-center uno-text-center">{{ $t('pages.userCourseLesson.ctaPrimary') }}</UButton>
