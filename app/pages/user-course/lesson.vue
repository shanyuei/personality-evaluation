<template>
  <div class="page-container uno-py-6">
    ...
    <!-- 内容卡片 -->
    <div class="uno-mt-4 uno-w-full lg:uno-w-[860px] uno-mx-auto uno-bg-white uno-rounded-[20px] overflow-hidden uno-shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
        ...
        <section>
          ...
          <div class="uno-space-y-3">
            <div class="uno-flex uno-items-start uno-gap-3">
              ...
              <div class="uno-flex-0 uno-mt-1 md:uno-mt-0.5 lg:uno-mt-0.3">
