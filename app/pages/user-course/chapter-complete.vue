  ...
  <main class="uno-min-h-screen uno-bg-gradient-to-br uno-from-[var(--color-green-4)] uno-to-[var(--color-pink-4)] uno-py-20 uno-px-6 md:uno-px-10">
    <div class="uno-max-w-[80%] uno-mx-auto">
      <div class="uno-flex uno-flex-col uno-items-center uno-text-center uno-gap-6">
        ...
        <h1 class="uno-text-[#011813] uno-text-5xl uno-font-['Outfit'] uno-text-center uno-font-semibold uno-leading-[1.2]">{{ $t('pages.userCourseChapterComplete.title') }}</h1>
        <p class="uno-text-sm md:uno-text-base uno-text-[#4E5255] uno-font-['Outfit'] uno-text-center uno-w-full md:uno-w-[520px] uno-mx-auto">{{ $t('pages.userCourseChapterComplete.desc1', { courseName }) }}</p>
        <p class="uno-text-sm md:uno-text-base uno-text-[#4E5255] uno-font-['Outfit'] uno-text-center uno-w-full md:uno-w-[520px] uno-mx-auto">{{ $t('pages.userCourseChapterComplete.desc2') }}</p>

        <div class="uno-space-y-3 uno-mt-2 uno-w-full md:uno-w-[520px] uno-mx-auto">
          <div class="uno-flex uno-items-start uno-gap-3">
            ...
            <p class="uno-text-[#4E5255] uno-text-sm uno-font-['Outfit'] uno-leading-normal uno-text-left"><span class="uno-text-[#4E5255] uno-text-sm uno-font-['Outfit'] uno-font-bold uno-leading-normal">{{ $t('pages.userCourseChapterComplete.format.title') }}</span>: {{ $t('pages.userCourseChapterComplete.format.body') }}</p>
          </div>
          <div class="uno-flex uno-items-start uno-gap-3">
            <span class="uno-inline-flex uno-items-center uno-justify-center uno-w-6 uno-h-6 uno-aspect-square uno-rounded-full uno-bg-white uno-border-2 uno-border-[var(--ui-primary)]">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M20 6L9 17l-5-5" stroke="var(--ui-primary)" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
            </span>
            <p class="uno-text-[#4E5255] uno-text-sm uno-font-['Outfit'] uno-leading-normal uno-text-left"><span class="uno-text-[#4E5255] uno-text-sm uno-font-['Outfit'] uno-font-bold uno-leading-normal">{{ $t('pages.userCourseChapterComplete.scoring.title') }}</span>: {{ $t('pages.userCourseChapterComplete.scoring.body') }}</p>
          </div>
        </div>
        ...
        <NuxtLink to="/user-course" class="uno-text-[#4E5255] uno-font-['Outfit'] uno-text-center hover:uno-text-[var(--ui-foreground)]">{{ $t('pages.userCourseChapterComplete.later') }}</NuxtLink>
      </div>
    </div>
  </main>
</template>
