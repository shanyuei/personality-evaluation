            ...
            <ul class="uno-space-y-4">
              <li v-for="recent in recentArticles" :key="recent.id">
                <NuxtLink :to="{
                  ...
                  <div>
                    <h4
                      class="uno-font-medium uno-text-[18px] uno-text-[#011813] uno-leading-[26px] group-hover:uno-text-[var(--ui-primary)] uno-transition-colors uno-duration-200 uno-line-clamp-1">
                      {{ recent.title }}</h4>
                    <p
                      class="uno-font-normal uno-text-[14px] uno-text-[#4e5255] uno-leading-[20px] uno-mt-1 uno-line-clamp-2">
                      {{ recent.excerpt }}</p>
                  </div>
                </NuxtLink>
              </li>
