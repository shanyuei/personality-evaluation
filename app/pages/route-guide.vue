<template>
  <main
    class="uno-min-h-screen uno-bg-gradient-to-br uno-from-gray-50 uno-to-gray-100 uno-py-8 uno-px-4 sm:uno-px-6 lg:uno-px-8">
    <div class="uno-max-w-7xl uno-mx-auto">
      ...
      <div class="uno-bg-white uno-rounded-2xl uno-shadow-xl uno-p-4 sm:uno-p-6 md:uno-p-8">
        ...
        <div class="uno-space-y-3 sm:uno-space-y-4" v-if="routes.length > 0">
          <div v-for="route in routes" :key="route.path" class="uno-group">
            <AppLink :to="route.path"
              ...
              <div class="uno-flex uno-flex-col md:uno-flex-row md:uno-items-center uno-justify-between">
                ...
                <div class="uno-mt-2 md:uno-mt-0 uno-flex-shrink-0">
                  <span
                    class="uno-inline-flex uno-items-center uno-px-3 uno-py-1 uno-rounded-full uno-text-xs sm:uno-text-sm uno-font-medium uno-bg-green-100 uno-text-green-800">
                    {{ $t('pages.routeGuide.visit') }}
                    <svg class="uno-w-4 uno-h-4 uno-ml-1 uno-transition-transform group-hover:uno-translate-x-1"
      ...
      <div class="uno-mt-6 sm:uno-mt-8 uno-text-center">
        <AppLink :to="'/'"
          ...
          <svg class="uno-w-4 uno-h-4 sm:uno-w-5 sm:uno-h-5 uno-mr-2" fill="none" stroke="currentColor"
            viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
