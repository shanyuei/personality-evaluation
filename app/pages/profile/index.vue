<template>
  <main class="uno-py-10 uno-px-6 md:uno-px-10">
    <div class="page-container uno-w-full md:uno-w-[90%] uno-mx-auto">
      ...
      <section class="uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
        <div class="uno-p-6 md:uno-p-8 uno-grid uno-gap-6 md:uno-grid-cols-3">
          ...
          <div class="uno-col-span-full md:uno-col-span-1">
            <h3 class="uno-text-[#323233] uno-text-base md:uno-text-lg uno-font-['Outfit'] uno-font-semibold uno-leading-normal">{{ $t('pages.profile.totalScore') }}</h3>
            <div class="uno-mt-3 uno-space-y-3">
              <div v-for="bar in scoreBars" :key="bar.label" class="uno-flex uno-items-center uno-gap-3">
                ...
                <span class="uno-w-28 uno-text-xs md:uno-text-sm uno-text-[#4E5255] uno-font-['Outfit'] uno-leading-normal">{{ bar.label }}</span>
          ...
          <div class="uno-col-span-full md:uno-col-span-1 uno-flex uno-items-center uno-justify-center">
            <NuxtImg src="/images/test/5.png" alt="Enneagram" class="uno-w-[200px] md:uno-w-[220px] uno-h-auto" />
          </div>
        </div>
      </section>            

      <div class="uno-grid uno-gap-6 md:uno-grid-cols-5 uno-mt-6">
        <section class="uno-col-span-full md:uno-col-span-3 uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
          <div class="uno-p-6 md:uno-p-8 uno-space-y-4">
            <span class="uno-text-[#4E5255] uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2] uno-mb-12">{{ $t('pages.profile.dailyTrivia') }}</span>
            <h3 class="uno-text-[#011813] uno-text-xl md:uno-text-2xl uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2]">{{ $t('pages.profile.triviaQuestion') }}</h3>
            <div class="uno-space-y-3">
              <URadioGroup v-model="triviaSelected" :items="radioItems" :ui="URadioTheme" />
              <UButton class="uno-h-[48px] uno-w-full md:uno-w-auto uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-1 uno-py-1 uno-px-[20px] uno-bg-[#009D77] uno-rounded-lg hover:uno-bg-[var(--color-green-2)] uno-text-[#FFFFFF] uno-text-base uno-font-['Outfit'] uno-font-bold uno-leading-normal">
                {{ $t('pages.profile.viewResults') }}
              </UButton>
            </div>
          </div>
        </section>

        <section class="uno-col-span-full md:uno-col-span-2 uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
          <div class="uno-p-6 md:uno-p-8">
            <span class="uno-text-[#4E5255] uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2] uno-mb-3">{{ $t('pages.profile.dailyStreak') }}</span>
            <div class="uno-flex uno-items-center uno-gap-2 uno-my-4">
              <div class="uno-text-[#011813] uno-text-[64px] md:uno-text-[88px] uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2]">0</div>
              <p class="uno-text-[#4E5255] uno-text-sm md:uno-text-base uno-font-['Outfit'] uno-leading-[1.6]">{{ $t('pages.profile.begin') }}</p>
            </div>
      ...
      <div class="uno-grid uno-gap-6 md:uno-grid-cols-5 uno-mt-6">
        <section class="uno-col-span-full md:uno-col-span-3 uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
          <div class="uno-p-6 md:uno-p-8 uno-space-y-6">
            <span class="uno-text-xs uno-text-[#4E5255] uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2]">{{ $t('pages.profile.continueCourse.label') }}</span>
            <h3 class="uno-text-[#011813] uno-text-xl md:uno-text-2xl uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2]">{{ $t('pages.profile.continueCourse.title') }}</h3>
            ...
            <div class="uno-flex uno-items-end uno-justify-between uno-gap-4">
              <UButton class="uno-h-[48px] uno-w-full md:uno-w-auto uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-1 uno-py-1 uno-px-[20px] uno-bg-[#009D77] uno-rounded-lg hover:uno-bg-[var(--color-green-2)] uno-text-[#FFFFFF] uno-text-sm uno-font-['Outfit'] uno-font-bold uno-leading-normal">{{ $t('pages.profile.continueCourse.cta') }}</UButton>
        ...
        <section class="uno-col-span-full md:uno-col-span-2 uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
          <div class="uno-p-6 md:uno-p-8 uno-space-y-6">
            <h3 class="uno-text-base md:uno-text-lg uno-text-[#4E5255] uno-font-['Outfit'] uno-font-semibold uno-leading-[1.2]">Your progress</h3>
            <div class="uno-space-y-4">
              <div class="uno-flex uno-items-end uno-justify-between">
                ...
                <div class="uno-text-[#323233] uno-text-4xl md:uno-text-5xl uno-font-['Outfit'] uno-font-semibold uno-mb-0">2</div>
              </div>
              ...
              <div class="uno-flex uno-items-end uno-justify-between">
                ...
                <div class="uno-text-[#323233] uno-text-4xl md:uno-text-5xl uno-font-['Outfit'] uno-font-semibold uno-mb-0">1</div>
              </div>
              <div class="uno-h-[2px] uno-bg-[var(--ui-border)]"></div>
              <div class="uno-flex uno-items-end uno-justify-between">
                <div class="uno-flex uno-items-center uno-gap-3">
      ...
      <section class="uno-mt-8">
        <h2 class="uno-text-2xl md:uno-text-[32px] uno-text-[#011813] uno-font-['Outfit'] uno-font-bold uno-leading-normal uno-mt-12 uno-mb-6">{{ $t('pages.profile.takeAnother') }}</h2>
        <div class="uno-grid uno-gap-6 md:uno-grid-cols-3">
          <div v-for="card in testCards" :key="card.id" class="uno-bg-white uno-rounded-[24px] uno-shadow-[0px_4px_12px_rgba(0,0,0,0.08)] uno-border uno-border-[var(--ui-border)]">
            <div class="uno-p-6 md:uno-p-8 uno-space-y-3">
              ...
              <h3 class="uno-text-[#011813] uno-text-lg md:uno-text-xl uno-font-['Outfit'] uno-font-semibold uno-leading-[1.24]">{{ card.title }}</h3>
              ...
              <div class="uno-flex uno-gap-3">
                <UButton class="uno-flex-1 uno-h-[48px] uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-1 uno-py-1 uno-px-[20px] uno-bg-[#009D77] uno-rounded-lg uno-text-[#FFFFFF] uno-text-base uno-font-['Outfit'] uno-font-bold uno-leading-normal hover:uno-bg-[var(--color-green-2)]">{{ $t('pages.profile.readMore') }}</UButton>
                <UButton v-if="card.try" class="uno-flex-1 uno-h-[48px] uno-flex uno-justify-center uno-items-center uno-flex-row uno-gap-1 uno-py-1 uno-px-[20px] uno-bg-white uno-border-2 uno-border-[#009D77] uno-rounded-lg uno-text-[#009D77] uno-text-base uno-font-['Outfit'] uno-font-bold uno-leading-normal hover:uno-bg-[#F0FDF9]">{{ $t('pages.profile.tryAgain') }}</UButton>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="uno-mt-8">
        <h2 class="uno-text-2xl md:uno-text-[32px] uno-text-[#011813] uno-font-['Outfit'] uno-font-bold uno-leading-normal uno-mt-12 uno-mb-6">{{ $t('pages.profile.continueLearning') }}</h2>
        <div class="uno-grid uno-gap-6 md:uno-grid-cols-3">
            ...
            <div class="uno-p-6 md:uno-p-8 uno-space-y-3">
              ...
              <div class="uno-mt-2">
                ...
                <div class="uno-flex uno-items-center uno-justify-between uno-mt-3">
                  <UButton class="uno-h-[40px] uno-w-[120px] uno-rounded-[12px] uno-bg-[var(--ui-primary)] hover:uno-bg-[var(--color-green-2)] uno-text-white uno-text-center uno-justify-center uno-text-sm">{{ $t('pages.profile.continueCourse.cta') }}</UButton>
